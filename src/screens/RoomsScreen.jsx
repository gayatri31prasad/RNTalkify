    ...
    <SafeAreaView style={styles.container}>
      <View style={{padding:16,paddingTop:6}}>
        ...
        <FlatList
          ...
          ListFooterComponent={() => 
            <TouchableOpacity style={{ marginTop: 16, backgroundColor: '#FF8000', padding: 8, borderRadius: 4,marginBottom:100}} onPress={()=>navigation.navigate('CreateRoom', { username })}>
              <Text  allowFontScaling={false} style={{fontSize:16,fontWeight:'600',color:'#fff',textAlign:'center'}}>Create New Room</Text>
            </TouchableOpacity>
          }
          />
        {/* <Button
...
const styles = StyleSheet.create({
  ...
  searchInput:{ borderWidth: 1, borderColor: '#FF8000', padding: 8, paddingHorizontal:16, marginTop: -5, borderRadius: 10 },
});
